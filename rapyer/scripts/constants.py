...
ATOMIC_GET_OR_CREATE_SCRIPT_NAME = "atomic_get_or_create"
CASCADE_TTL_APPLY_SCRIPT_NAME = "cascade_ttl_apply"
CASCADE_LIBRARY_PREFIX = "rapyer_cascade"
CASCADE_FUNCTION_PREFIX = "cascade_apply"
