...
_NUM_POW_FLOAT_SCRIPT_TEMPLATE = """
local key = KEYS[1]
local path = ARGV[1]
local operand = tonumber(ARGV[2])
...
_EXTRACT_DATETIME_STR = "local value = cjson.decode(current_json)[1]"
...
NUM_POW_FLOAT_SCRIPT = _NUM_POW_FLOAT_SCRIPT_TEMPLATE.format(
    extract_value=_EXTRACT_VALUE_REDIS
)
NUM_POW_FLOAT_SCRIPT_FAKEREDIS = _NUM_POW_FLOAT_SCRIPT_TEMPLATE.format(
    extract_value=_EXTRACT_VALUE_FAKEREDIS
)
...
STR_MUL_SCRIPT = _STR_MUL_SCRIPT_TEMPLATE.format(extract_value=_EXTRACT_STR_REDIS)
STR_MUL_SCRIPT_FAKEREDIS = _STR_MUL_SCRIPT_TEMPLATE.format(
    extract_value=_EXTRACT_STR_FAKEREDIS
)
DATETIME_ADD_SCRIPT = _DATETIME_ADD_SCRIPT_TEMPLATE.format(
    extract_value=_EXTRACT_DATETIME_STR
)
DATETIME_ADD_SCRIPT_FAKEREDIS = _DATETIME_ADD_SCRIPT_TEMPLATE.format(
    extract_value=_EXTRACT_DATETIME_STR
)
...
SCRIPTS: dict[str, str] = {
    ...
    NUM_POW_FLOAT_SCRIPT_NAME: NUM_POW_FLOAT_SCRIPT,
    NUM_TRUEDIV_SCRIPT_NAME: NUM_TRUEDIV_SCRIPT,
    STR_APPEND_SCRIPT_NAME: STR_APPEND_SCRIPT,
    STR_MUL_SCRIPT_NAME: STR_MUL_SCRIPT,
    DATETIME_ADD_SCRIPT_NAME: DATETIME_ADD_SCRIPT,
}
...
SCRIPTS_FAKEREDIS: dict[str, str] = {
    ...
    NUM_POW_FLOAT_SCRIPT_NAME: NUM_POW_FLOAT_SCRIPT_FAKEREDIS,
    NUM_TRUEDIV_SCRIPT_NAME: NUM_TRUEDIV_SCRIPT_FAKEREDIS,
    STR_APPEND_SCRIPT_NAME: STR_APPEND_SCRIPT_FAKEREDIS,
    STR_MUL_SCRIPT_NAME: STR_MUL_SCRIPT_FAKEREDIS,
    DATETIME_ADD_SCRIPT_NAME: DATETIME_ADD_SCRIPT_FAKEREDIS,
}
