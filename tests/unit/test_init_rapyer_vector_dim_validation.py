...
from rapyer.base import REDIS_MODELS, AtomicRedisModel, RedisConfig
...
# Preset Meta.vectorizer keeps these globally-registered models off the real default adapter.
...
REDIS_MODELS.remove(MismatchedDimModel)
