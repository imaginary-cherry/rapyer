...
@pytest.mark.asyncio
async def test_apipeline_ignore_redis_error_true__model_not_saved_returns_created_model_sanity():
    # Arrange
...
@pytest.mark.asyncio
async def test_apipeline_ignore_redis_error_false__model_not_saved_raises_key_not_found_edge_case():
    # Arrange
    model = ComprehensiveTestModel(name="test", counter=42)
